...
export default function About() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-12">
      <h2 className="text-3xl font-bold text-slate-900 mb-4 tracking-tight">About Me</h2>
      ...
      <h3 className="text-xl font-bold text-slate-900 mb-6">Technical Specialties & Areas of Interest</h3>
      
      {/* Contenedor en grilla para las tarjetas de habilidades */}
